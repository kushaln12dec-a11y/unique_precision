...
const schemaStatements: string[] = [
  ...
  `ALTER TABLE "MasterConfig" ADD COLUMN IF NOT EXISTS "complexExtraHours" NUMERIC(10, 2);`,
  `ALTER TABLE "MasterConfig" ADD COLUMN IF NOT EXISTS "pipExtraHours" NUMERIC(10, 2);`,
  ...
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm034Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm034PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm056Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm056PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm07Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm07PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm0812Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm0812PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm1520Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm1520PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm2225Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm2225PerMm" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm30Min" NUMERIC(12, 2);`,
  `ALTER TABLE "MasterConfigCustomer" ADD COLUMN IF NOT EXISTS "sedm30PerMm" NUMERIC(12, 2);`,
];
